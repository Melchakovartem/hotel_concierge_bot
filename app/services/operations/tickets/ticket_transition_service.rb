module Operations
  module Tickets
    class TicketTransitionService < BaseService
      option :staff
      option :ticket
      ...
      def precondition_failure
        ...
        failure_for(:validation_failed, transition_error_message) unless valid_source_status?
      end
      ...
      def target_status = raise NotImplementedError
      def valid_source_status? = raise NotImplementedError
      def transition_error_message = raise NotImplementedError
    end
  end
end
