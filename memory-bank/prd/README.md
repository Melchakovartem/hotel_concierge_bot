...
- [`PRD.md`](PRD.md)
  **Что:** Product Requirements Document для Hotel Concierge Bot MVP.
  **Читать, чтобы:** восстановить product goals, scope, user stories, success metrics и out-of-scope ограничения проекта.
